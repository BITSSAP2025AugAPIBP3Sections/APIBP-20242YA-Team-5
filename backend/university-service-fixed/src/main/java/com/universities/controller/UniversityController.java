...
public class UniversityController {
    ...
    public ResponseEntity<VerifyUniversityResponse> verifyUniversity(@PathVariable UUID id) {
    ...
    public ResponseEntity<PublicKeyResponse> getUniversityPublicKey(@PathVariable UUID id) {
